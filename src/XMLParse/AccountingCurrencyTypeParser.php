...
class AccountingCurrencyTypeParser extends Sie5ParserBase
{
    /**
     * Parse
     *
     ...
     */
    public function parse() : AccountingCurrencyType
    {
        $accountingCurrencyType = AccountingCurrencyType::factory()->setXMLattributes( $this->reader );
        $this->logger->debug(
