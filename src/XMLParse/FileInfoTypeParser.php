...
class FileInfoTypeParser extends Sie5ParserBase
{
    /**
     * Parse
     *
     ...
     * @throws Exception
     */
    public function parse() : FileInfoType
    {
        $fileInfoType = FileInfoType::factory()->setXMLattributes( $this->reader );
        $this->logger->debug(
        ...
        if( $this->reader->hasAttributes ) {
            ...
            if( isset( $extensionAttributes[self::XSITYPE] ) && ( 2 <= count( $extensionAttributes ))) {
                ...
                $fileInfoType->setExtensionAttributes( $extensionAttributes );
            }
