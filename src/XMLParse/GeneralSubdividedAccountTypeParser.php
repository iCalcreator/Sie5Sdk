...
class GeneralSubdividedAccountTypeParser extends Sie5ParserBase
{
    /**
     * Parse
     *
     ...
     * @throws Exception
     */
    public function parse() : GeneralSubdividedAccountType
    {
        $generalSubdividedAccountType = GeneralSubdividedAccountType::factory()->setXMLattributes( $this->reader );
        $this->logger->debug(
            ...
            while( $this->reader->moveToNextAttribute()) {
                ...
                switch( $this->reader->name ) {
                    case self::PRIMARYACCOUNTID :
                        $generalSubdividedAccountType->setPrimaryAccountId( $this->reader->value );
                        break;
                    case self::NAME :
                        $generalSubdividedAccountType->setName( $this->reader->value );
                        break;
                } // end switch
            } // end while
