...
class SieEntry extends Sie5DtoBase implements Sie5DtoInterface
{
    ...
    /**
     * @var array [ *CustomerInvoicesTypeEntry ]
    ...
    /**
     * @var array   [ *SupplierInvoicesTypeEntry ]
     *                        minOccurs="0" maxOccurs="unbounded"
     * @access private
     */
    ...
    /**
     * @var array   [ *FixedAssetsTypeEntry ]
     *                        minOccurs="0" maxOccurs="unbounded"
     * @access private
     */
    private $fixedAssets = [];
    ...
    /**
     * @var array    [ *GeneralSubdividedAccountTypeEntry ]
     *                        minOccurs="0" maxOccurs="unbounded"
     * @access private
     */
     ...
     * @return static
     */
    public function setFileInfo( FileInfoTypeEntry $fileInfo ) {
     ...
     * @return static
     */
    public function setAccounts( AccountsTypeEntry $accounts ) {
     ...
     * @return static
     */
    public function setDimensions( DimensionsTypeEntry $dimensions ) {
     ...
     * @return static
     */
    public function addCustomerInvoices( CustomerInvoicesTypeEntry $customerInvoices ) {
     ...
     * @return static
     */
    public function addSupplierInvoices( SupplierInvoicesTypeEntry $supplierInvoices ) {
     ...
     * @return static
     */
    public function addFixedAsset( FixedAssetsTypeEntry $fixedAsset ) {
    ...
    /**
     * @param array $fixedAssets   *FixedAssetsTypeEntry
     * @return static
     * @throws InvalidArgumentException
     */
     ...
     * @return static
     */
    public function addGeneralSubdividedAccount( GeneralSubdividedAccountTypeEntry $generalSubdividedAccount ) {
    ...
    /**
     * @param array $generalSubdividedAccount *GeneralSubdividedAccountTypeEntry
     * @return static
     * @throws InvalidArgumentException
     */
     ...
     * @return static
     */
    public function addJournal( JournalTypeEntry $journal ) {
    ...
    /**
     * @param array $journal   *JournalTypeEntry
     * @return static
     * @throws InvalidArgumentException
     */
