...
class SupplierInvoicesTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( SupplierInvoicesType $supplierInvoicesType ) {
        ...
        parent::writeAttribute( $this->writer, self::NAME, $supplierInvoicesType->getName());

        foreach( $supplierInvoicesType->getSecondaryAccountRef() as $accountId ) {
        ...
        foreach( $supplierInvoicesType->getSupplierInvoice() as $element ) {
