...
class SuppliersTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( SuppliersType $suppliersType ) {
        ...
        $writer = new SupplierTypeWriter( $this->writer );
        foreach( $suppliersType->getSupplier() as $element ) {
