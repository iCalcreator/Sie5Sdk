...
class EmbeddedFileTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( EmbeddedFileType $embeddedFileType ) {
        ...
        parent::writeAttribute( $this->writer, self::ID,       $embeddedFileType->getId());
        ...
        if( ! is_null( $embeddedFile )) {
            $this->writer->text( $embeddedFile );
        }
