...
class DimensionsTypeEntryWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( DimensionsTypeEntry $dimensionsTypeEntry ) {
        ...
        $writer = new DimensionTypeEntryWriter( $this->writer );
        foreach( $dimensionsTypeEntry->getDimension() as $dimension ) {
