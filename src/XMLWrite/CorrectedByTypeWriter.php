...
class CorrectedByTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( CorrectedByType $correctedByType ) {
        ...
        parent::writeAttribute( $this->writer, self::JOURNALENTRYID, $correctedByType->getJournalEntryId());
