...
class SupplierInvoicesTypeEntryWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( SupplierInvoicesTypeEntry $supplierInvoicesTypeEntry ) {
        ...
        $writer = new SupplierInvoiceTypeEntryWriter( $this->writer );
        foreach( $supplierInvoicesTypeEntry->getSupplierInvoice() as $element ) {
