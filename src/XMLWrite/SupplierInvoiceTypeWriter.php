...
class SupplierInvoiceTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( SupplierInvoiceType $supplierInvoiceType ) {
        ...
        parent::writeAttribute( $this->writer, self::NAME, $supplierInvoiceType->getName());
        ...
        parent::writeAttribute( $this->writer, self::OCRNUMBER, $supplierInvoiceType->getOcrNumber());
        ...
        foreach( $supplierInvoiceType->getBalances() as $element ) {
            $writer->write( $element );
        }

        $originalAmount = $supplierInvoiceType->getOriginalAmount();
