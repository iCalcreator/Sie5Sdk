...
class JournalTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( JournalType $journalType ) {
        ...
        $writer = new JournalEntryTypeWriter( $this->writer );
        foreach( $journalType->getJournalEntry() as $element ) {
