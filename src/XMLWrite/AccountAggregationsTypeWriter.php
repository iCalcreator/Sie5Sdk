...
class AccountAggregationsTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( AccountAggregationsType $accountAggregationsType ) {
        ...
        $writer = new AccountAggregationTypeWriter( $this->writer );
        foreach( $accountAggregationsType->getAccountAggregation() as $element ) {
