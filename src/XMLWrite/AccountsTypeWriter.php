...
class AccountsTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( AccountsType $accountsType ) {
        ...
        $writer = new AccountTypeWriter( $this->writer );
        foreach( $accountsType->getAccount() as $accountTypes ) {
