...
class FixedAssetsTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( FixedAssetsType $fixedAssetsType ) {
        ...
        parent::writeAttribute( $this->writer, self::NAME, $fixedAssetsType->getName());

        foreach( $fixedAssetsType->getSecondaryAccountRef() as $accountId ) {
        ...
        $writer = new FixedAssetTypeWriter( $this->writer );
        foreach( $fixedAssetsType->getFixedAsset() as $element ) {
