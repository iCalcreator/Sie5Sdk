...
class BaseBalanceTypeWriter extends Sie5WriterBase implements Sie5WriterInterface
{
     ...
     *
     */
    public function write( BaseBalanceType $baseBalanceType, $elementName ) {
        ...
        parent::writeAttribute( $this->writer, self::AMOUNT,   $baseBalanceType->getAmount());
        parent::writeAttribute( $this->writer, self::QUANTITY, $baseBalanceType->getQuantity());
        ...
        foreach( $baseBalanceType->getBaseBalanceTypes() as $elementSet ) {
