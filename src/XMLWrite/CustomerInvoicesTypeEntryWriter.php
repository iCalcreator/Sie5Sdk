...
class CustomerInvoicesTypeEntryWriter extends Sie5WriterBase implements Sie5WriterInterface
{
    ...
    public function write( CustomerInvoicesTypeEntry $customerInvoicesType ) {
        ...
        $writer = new CustomerInvoiceTypeEntryWriter( $this->writer );
        foreach( $customerInvoicesType->getCustomerInvoice() as $element ) {
